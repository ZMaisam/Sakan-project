...
$type     = $_POST['role']; // "student" أو "renter"
...
if($type == "renter"){
    $sql = "INSERT INTO renter (name, phone, email, password) VALUES ('$name','$phone','$email','$hashed')";
    ...
    $sql = "INSERT INTO student (name, phone, email, password) VALUES ('$name','$phone','$email','$hashed')";
    if($conn->query($sql) === TRUE){
