...
if($role == "renter"){
    $sql = "INSERT INTO renter (name, phone, email, password,gender) VALUES ('$name','$phone','$email','$hashed','$type')";
    ...
    $sql = "INSERT INTO student (name, phone, email, password,gender) VALUES ('$name','$phone','$email','$hashed','$type')";
    if($conn->query($sql) === TRUE){
